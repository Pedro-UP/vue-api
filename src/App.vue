...
<template>
   <div>
      <a href="https://vitejs.dev" target="_blank">
         <img src="/image/iconojpg.jpg" class="logo" alt="Vite logo" />
      </a>
   </div>
  ...
  * informacion al metodo shearcData. -->
   <input type="text" v-model="search" v-on:keyup.enter="searchData" placeholder="Buscar receta" class="search-imput" />

   <Meal v-for="meal in paginatedM" v-bind:key="meal.idMeal" v-bind:meal="meal"></Meal>
   ...
   <category v-for="category in paginated" v-bind:key="category.idCategory" v-bind:category="category"></category>
...
<!-- //* Esta funcion utiliza axios para poder acceder a la api en este caso especificamente a
* categorias y si la consulta fue correcta lo mostrara con el metodo then, si hay un error
* nos lo mostrara a traves del metodo cath que es para ver el error y todo esto lo veremos
